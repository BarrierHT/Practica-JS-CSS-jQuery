...
$('#sesion').submit((e) => {
	...
	if( localStorage.getItem(nombre)!= null ){
		if(localStorage.getItem(nombre) == contra){

		$('li #usuario').html(nombre);									//Actualiza Pefil en la barra de navegacion
		$('li #usuario').attr("href","#miperfil");

		let reinicio = $('<a href="C:/Users/User/Desktop/Proyecto/Web/web.html" id="cierre"> Cerrar sesion</a>');	//Cerrar sesion
		reinicio.css("background","red").css("color","#fff") .css("padding","12px 20px").css("font-size","20px")
				.css("font-family","Verdana,Arial")
			    .css("font-weight","bold");

		$('#sesion').html(reinicio);							//Añadir el boton al lugar del formulario
...
/*SLIDER*/
const arr = ["../aurora.jpg","../atardecer.jpg","../bosque.jpg","../lava.jpg","../tornado.jpg"];		//Imagenes
let i = 0;
